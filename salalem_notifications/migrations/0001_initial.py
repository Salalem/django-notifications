# Generated by Django 2.1.4 on 2019-02-13 21:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verb_ar', models.CharField(max_length=255, null=True)),
                ...
                ('sent_sms', models.BooleanField(db_index=True, default=False)),
                ('sent_to_browser', models.BooleanField(db_index=True, default=False)),
                ('sent_to_android', models.BooleanField(db_index=True, default=False)),
                ('sent_to_ios', models.BooleanField(db_index=True, default=False)),
